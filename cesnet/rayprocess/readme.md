...
```
qsub -l select=1:ncpus=6:mem=24gb:scratch_local=25gb -l walltime=12:00:00 -- /storage/projects2/InterCOST/segment.sh rz_01.laz /storage/plzen1/home/krucek/data/rz_voxelized false 0.02 true
qsub -l select=1:ncpus=6:mem=24gb:scratch_local=25gb -l walltime=12:00:00 -- /storage/projects2/InterCOST/segment.sh rz_03.laz /storage/plzen1/home/krucek/data/rz_voxelized false 0.02 true
qsub -l select=1:ncpus=6:mem=24gb:scratch_local=25gb -l walltime=12:00:00 -- /storage/projects2/InterCOST/segment.sh rz_04.laz /storage/plzen1/home/krucek/data/rz_voxelized false 0.02 true
qsub -l select=1:ncpus=6:mem=24gb:scratch_local=25gb -l walltime=12:00:00 -- /storage/projects2/InterCOST/segment.sh rz_05.laz /storage/plzen1/home/krucek/data/rz_voxelized false 0.02 true
