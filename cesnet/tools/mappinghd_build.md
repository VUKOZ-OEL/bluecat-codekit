...
qsub -I -l select=1:ncpus=4:mem=8gb:scratch_local=32gb -l walltime=00:30:00

module purge
module add git/2.35.2-gcc-10.2.1-ys3caml
module add python/3.9.12-gcc-10.2.1-rg2lpmk
module add opencv/4.5.4-gcc-10.2.1-663hk5g
git clone https://github.com/VUKOZ-OEL/hdmap2hpcpy.git
cd hdmap2hpcpy
mkdir build
git submodule init
git submodule update --recursive
...
/storage/plzen1/home/krucek/cmake/cmake-4.2.0-linux-x86_64/bin/cmake -DCMAKE_BUILD_TYPE=Release -DBUILD_WITH_PYBIND=ON ..
